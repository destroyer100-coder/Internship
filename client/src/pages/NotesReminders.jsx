...
const INITIAL_NOTES = [
  {
    ...
    title: 'Design Ideas',
    pinned: true,
    content: 'New landing page with modern, clean UI.',
    items: ['Hero section', 'Features', 'Testimonials', 'CTA'],
    tag: 'Work',
    tagColor: 'bg-[#FAF2E6] text-[#B78332]',
    dateStr: '24 Aug, 09:15 AM',
    bg: 'bg-[#FAF2E6]/60 dark:bg-[#172638] border-[#EADCC8] dark:border-[#1E2D40]',
  ...
  },
  {
    ...
    isChecklist: true,
    checklist: [
      { text: 'Complete 2 projects', done: true },
      { text: 'Read 2 books', done: true },
      { text: 'Learn Advanced React', done: false },
      { text: 'Save ₹20,000', done: false },
    ],
    tag: 'Personal',
    tagColor: 'bg-[#EBF3EF] text-[#4F8068]',
    dateStr: '23 Aug, 07:40 PM',
    bg: 'bg-[#EBF3EF]/60 dark:bg-[#172638] border-[#C8DDD2] dark:border-[#1E2D40]',
    textColor: 'text-[#17202A] dark:text-white',
    iconType: 'pin'
  },
  {
    ...
    title: 'Content Plan',
    pinned: false,
    items: ['Productivity tips', 'Time management', 'Deep work guide', 'TaskFlow walkthrough'],
    tag: 'Work',
    tagColor: 'bg-[#EEF3F8] text-[#61758A]',
    dateStr: '22 Aug, 03:20 PM',
    bg: 'bg-[#EEF3F8]/60 dark:bg-[#172638] border-[#CAD8E6] dark:border-[#1E2D40]',
    textColor: 'text-[#17202A] dark:text-white',
    iconType: 'document'
  },
  {
    ...
    title: 'Workout Plan',
    pinned: false,
    content: 'Push • Pull • Legs\n3 days a week\n\nDaily Steps Goal:\n10,000 steps',
    tag: 'Health',
    tagColor: 'bg-[#101C2B] text-white',
    dateStr: '21 Aug, 06:10 PM',
    bg: 'bg-[#101C2B] text-white border-[#1E2D40]',
  ...
  },
  {
    ...
    title: 'Book List',
    pinned: false,
    items: ['Atomic Habits', 'Deep Work', 'The 5 AM Club', 'Thinking, Fast & Slow'],
    tag: 'Reading',
    tagColor: 'bg-[#FAF2E6] text-[#B78332]',
    dateStr: '20 Aug, 11:30 AM',
    bg: 'bg-[#FAF2E6]/60 dark:bg-[#172638] border-[#EADCC8] dark:border-[#1E2D40]',
    textColor: 'text-[#17202A] dark:text-white',
    iconType: 'book'
  },
  {
    ...
    title: 'Work Ideas',
    pinned: false,
    content: 'Gamify daily progress on TaskFlow.\n\nBadges, streaks, and achievements.',
    tag: 'Ideas',
    tagColor: 'bg-[#F3EDF4] text-[#765C78]',
    dateStr: '20 Aug, 10:05 AM',
    bg: 'bg-[#765C78] text-white border-[#5B435C]',
    textColor: 'text-white',
    iconType: 'lightbulb'
  },
  {
    ...
    title: 'Meeting Notes',
    pinned: false,
    items: ['Discuss Q3 roadmap', 'Review analytics', 'Plan marketing campaign'],
    tag: 'Work',
    tagColor: 'bg-[#F1EFE9] text-[#5F6872]',
    dateStr: '19 Aug, 04:50 PM',
    bg: 'bg-[#F7F5F0] dark:bg-[#172638] border-[#DEDCD5] dark:border-[#1E2D40]',
    textColor: 'text-[#17202A] dark:text-white',
    iconType: 'users'
  },
  {
...
const INITIAL_REMINDERS = [
  { id: 'r1', title: 'Client Call', subtitle: 'Task • Client Call', time: 'Today, 02:00 PM', filterGroup: 'Today', badge: 'in 1h 15m', badgeBg: 'bg-[#EBF3EF] text-[#4F8068]', iconType: 'phone', iconBg: 'bg-[#EBF3EF] text-[#4F8068]', starred: false, done: false },
  { id: 'r2', title: 'Submit Monthly Report', subtitle: 'Task • Prepare Report', time: 'Today, 06:00 PM', filterGroup: 'Today', badge: 'in 5h 15m', badgeBg: 'bg-[#EEF3F8] text-[#61758A]', iconType: 'file', iconBg: 'bg-[#EEF3F8] text-[#61758A]', starred: false, done: false },
  { id: 'r3', title: 'Workout', subtitle: 'Note', time: 'Today, 07:00 PM', filterGroup: 'Today', badge: 'in 6h 15m', badgeBg: 'bg-[#F3EDF4] text-[#765C78]', iconType: 'dumbbell', iconBg: 'bg-[#F3EDF4] text-[#765C78]', starred: false, done: false },
  { id: 'r4', title: 'Buy Groceries', subtitle: 'Note', time: 'Tomorrow, 11:00 AM', filterGroup: 'Tomorrow', badge: 'in 20h', badgeBg: 'bg-[#FAF2E6] text-[#B78332]', iconType: 'cart', iconBg: 'bg-[#FAF2E6] text-[#B78332]', starred: false, done: false },
  { id: 'r5', title: 'Team Standup', subtitle: 'Task • Team Sync', time: 'Tomorrow, 10:00 AM', filterGroup: 'Tomorrow', badge: 'in 19h', badgeBg: 'bg-[#E7F0EC] text-[#145A4A]', iconType: 'users', iconBg: 'bg-[#E7F0EC] text-[#145A4A]', starred: false, done: false },
  { id: 'r6', title: "Mom's Birthday", subtitle: 'Reminder', time: '24 Aug, All Day', filterGroup: 'This Week', badge: '2 days left', badgeBg: 'bg-[#FAF2E6] text-[#B78332]', iconType: 'cake', iconBg: 'bg-[#FAF2E6] text-[#B78332]', starred: false, done: false },
  { id: 'r7', title: 'Flight to Delhi', subtitle: 'Reminder', time: '28 Aug, 09:30 AM', filterGroup: 'This Week', badge: '6 days left', badgeBg: 'bg-[#EEF3F8] text-[#61758A]', iconType: 'plane', iconBg: 'bg-[#EEF3F8] text-[#61758A]', starred: false, done: false },
]
