...
const INITIAL_DEMO_TASKS = [
  {
    ...
    description: 'Compile department data and prepare slides for the monthly performance review.',
    dueDate: '2026-08-26',
    dueTime: '11:00',
    priority: 'High',
    status: 'In Progress',
    ...
    notes: 'Focus on sales and marketing metrics. Use last month\'s template.',
    loggedTime: '1h 25m',
    remainingTime: '1h 35m',
    scheduledRange: '11:00 AM - 2:00 PM',
    progress: 47,
    createdAt: '24 Aug 2026, 09:15 AM',
    updatedAt: '26 Aug 2026, 09:30 AM',
    iconType: 'file',
    iconBg: 'bg-[#E7F0EC] text-[#145A4A]'
  },
  {
    _id: 'task-2',
    title: 'Client Call',
    description: 'Project discussion with client to align on quarterly deliverables.',
    dueDate: '2026-08-26',
    dueTime: '14:00',
    priority: 'High',
    status: 'In Progress',
    ...
    timeEstimated: '1.5h',
    starred: false,
    reminder: '26 Aug 2026, 01:30 PM',
    recurrence: 'Does not repeat',
    notes: 'Prepare sprint milestone status and demo recording.',
    loggedTime: '1h 00m',
    remainingTime: '30m',
    scheduledRange: '2:00 PM - 3:30 PM',
    progress: 66,
    createdAt: '25 Aug 2026, 10:00 AM',
    updatedAt: '26 Aug 2026, 11:00 AM',
    iconType: 'users',
    iconBg: 'bg-[#F3EDF4] text-[#765C78]'
  },
  {
    _id: 'task-3',
    title: 'Review & Approve Documents',
    description: 'Finance team documents review and budget allocation approvals.',
    dueDate: '2026-08-26',
    dueTime: '16:00',
    priority: 'Medium',
    status: 'To Do',
    ...
    timeEstimated: '2h',
    starred: false,
    reminder: '26 Aug 2026, 03:00 PM',
    recurrence: 'Weekly',
    notes: 'Check vendor invoices and departmental variance.',
    loggedTime: '0m',
    remainingTime: '2h 00m',
    scheduledRange: '4:00 PM - 6:00 PM',
    progress: 0,
    createdAt: '25 Aug 2026, 02:00 PM',
  ...
  },
  {
    _id: 'task-4',
    title: 'Workout',
    description: 'Evening gym session - upper body training.',
    dueDate: '2026-08-26',
    dueTime: '18:00',
    priority: 'Low',
    status: 'To Do',
    ...
    timeEstimated: '1h',
    starred: false,
    reminder: '26 Aug 2026, 05:30 PM',
    recurrence: 'Daily',
    notes: 'Warm-up 10 mins, bench press, pullups.',
    loggedTime: '0m',
    remainingTime: '1h 00m',
    scheduledRange: '6:00 PM - 7:00 PM',
    progress: 0,
    createdAt: '26 Aug 2026, 07:00 AM',
    updatedAt: '26 Aug 2026, 07:00 AM',
    iconType: 'dumbbell',
  ...
  },
  {
    ...
    timeEstimated: '4h',
    starred: false,
    reminder: '27 Aug 2026, 10:00 AM',
    recurrence: 'Does not repeat',
    notes: 'Incorporate dark theme tokens and responsive layouts.',
    loggedTime: '0m',
    remainingTime: '4h 00m',
    scheduledRange: '11:00 AM - 3:00 PM',
    progress: 0,
    createdAt: '24 Aug 2026, 11:30 AM',
    updatedAt: '25 Aug 2026, 04:00 PM',
    iconType: 'monitor',
    iconBg: 'bg-[#EEF3F8] text-[#61758A]'
  },
  {
    _id: 'task-6',
    title: 'Project Deadline',
    description: 'Submit all deliverables for client milestone verification.',
    dueDate: '2026-08-28',
    dueTime: '18:30',
    priority: 'High',
    status: 'To Do',
    ...
    timeEstimated: '2h',
    starred: true,
    reminder: '28 Aug 2026, 04:00 PM',
    recurrence: 'Does not repeat',
    notes: 'Double check test coverage and deployment scripts.',
    loggedTime: '0m',
    remainingTime: '2h 00m',
    scheduledRange: '6:30 PM - 8:30 PM',
    progress: 0,
    createdAt: '25 Aug 2026, 01:00 PM',
    updatedAt: '26 Aug 2026, 09:00 AM',
    iconType: 'flag',
    iconBg: 'bg-[#F8EBEA] text-[#B65D52]'
  },
  {
    _id: 'task-7',
    title: 'Groceries Shopping',
    description: 'Weekly household supplies and organic groceries restock.',
    dueDate: '2026-08-29',
    dueTime: '17:00',
    priority: 'Low',
    status: 'To Do',
    ...
    timeEstimated: '1h',
    starred: false,
    reminder: '29 Aug 2026, 04:00 PM',
    recurrence: 'Weekly',
    notes: 'Fruits, almond milk, coffee beans, bread.',
    loggedTime: '0m',
    remainingTime: '1h 00m',
    scheduledRange: '5:00 PM - 6:00 PM',
    progress: 0,
    createdAt: '26 Aug 2026, 08:00 AM',
    updatedAt: '26 Aug 2026, 08:00 AM',
    iconType: 'cart',
    iconBg: 'bg-[#EBF3EF] text-[#4F8068]'
  },
  {
    ...
    description: 'Bi-weekly sprint retrospective to review progress & bottlenecks.',
    dueDate: '2026-08-30',
    dueTime: '15:00',
    priority: 'Medium',
    status: 'To Do',
    ...
    timeEstimated: '1h',
    starred: false,
    reminder: '30 Aug 2026, 02:30 PM',
    recurrence: 'Bi-weekly',
    notes: 'Prepare kudos and action items for next sprint.',
    loggedTime: '0m',
    remainingTime: '1h 00m',
    scheduledRange: '3:00 PM - 4:00 PM',
    progress: 0,
